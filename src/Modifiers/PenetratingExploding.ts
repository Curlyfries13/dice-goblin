...
export default class PenetratingExploding implements Modifier, DiceTerm {
  ...
  constructor(base: DiceTerm, target?: StatisticalGenerator, compare?: CompareMode) {
    ...
    // work
    // NOTE it might actually work; averages seem to provide the correct values.
    ...
    this.reroller = new Subtract(new SimpleDiceGroup(this.base.sides.statProps.max, 1), new Constant(1));
